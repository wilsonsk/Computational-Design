...
In its simplest form, [[Euclidean Transformations#Generative Point Transformations|transforming a point]] into a curve can be thought of as the trace of a point's path as it moves according to some rule or function. 
